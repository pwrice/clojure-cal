...
get the app created:
    ...
    $ heroku apps:create calculator
    Creating calculator... done, stack is cedar
    http://calculator.herokuapp.com/ | git@heroku.com:calculator.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://calculator.herokuapp.com deployed to Heroku

    To git@heroku.com:calculator.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://calculator.herokuap.com
    ["Hello" :from Heroku]
